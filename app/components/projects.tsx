...
export default function Projects() {
    return (
        <section id="projects" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="Selected projects">
            ...
            <div className="mt-12">
                <a className="inline-flex items-baseline font-medium leading-tight group/link text-base font-space" href="https://github.com/ClayMicholaz" target="_blank" rel="noopener noreferrer" aria-label="View Full CV (opens in a new tab)">
                    <span>
